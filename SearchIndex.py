...
if __name__ == '__main__':
    ...
    try:
        ...
        for r in response:
            ...
            print('DIRECTION = %s' % r['direccion'])
            print('DESCRIPTION = %s' % r['descripcion'])
            print('PRICE = %s' % r['precio'])
            print('ROOMS = %s' % r['nHabitaciones'])
            print('M2 = %s' % r['metrosCuadrados'])
            print('BATHROOMS = %s' % r['nBanyos'])
            print('----------------------------------------')
